if exists (select * from sys.objects where name='ACRA_COBORROWER_QUERY_RESULT_DETAILS' and type='U')
	drop table Common.ACRA_COBORROWER_QUERY_RESULT_DETAILS
GO

CREATE TABLE Common.ACRA_COBORROWER_QUERY_RESULT_DETAILS(
...
CREATE CLUSTERED INDEX iACRA_COBORROWER_QUERY_RESULT_DETAILS1 ON Common.ACRA_COBORROWER_QUERY_RESULT_DETAILS (APPLICATION_ID)
GO
