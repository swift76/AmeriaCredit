if exists (select * from sys.objects where name='CUSTOMER_USER' and type='U')
	drop table Common.CUSTOMER_USER
GO

CREATE TABLE Common.CUSTOMER_USER(
...
CREATE UNIQUE CLUSTERED INDEX iCUSTOMER_USER1 ON Common.CUSTOMER_USER (APPLICATION_USER_ID)
GO
