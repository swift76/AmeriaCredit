if exists (select * from sys.objects where name='NORQ_COBORROWER_QUERY_RESULT' and type='U')
	drop table Common.NORQ_COBORROWER_QUERY_RESULT
GO

CREATE TABLE Common.NORQ_COBORROWER_QUERY_RESULT(
...
CREATE UNIQUE CLUSTERED INDEX iNORQ_COBORROWER_QUERY_RESULT1 ON Common.NORQ_COBORROWER_QUERY_RESULT (APPLICATION_ID)
GO
