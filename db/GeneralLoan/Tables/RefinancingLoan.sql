if exists (select * from sys.objects where name='REFINANCING_LOAN' and type='U')
	drop table GL.REFINANCING_LOAN
GO

CREATE TABLE GL.REFINANCING_LOAN (
...
CREATE UNIQUE CLUSTERED INDEX iREFINANCING_LOAN1 ON GL.REFINANCING_LOAN(APPLICATION_ID,ROW_ID)
GO
